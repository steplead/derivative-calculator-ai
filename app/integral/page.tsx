        ...
        <main className="min-h-screen bg-slate-900 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center mb-12 mt-10">
                <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight mb-4">
                    Integral Calculator <span className="text-purple-500">AI</span>
                </h1>
            ...
            <div className="max-w-4xl mx-auto mt-20 prose prose-invert">
                <div className="grid md:grid-cols-2 gap-12">
                    <div>
                        <h2 className="text-2xl font-bold text-white mb-4">How to use this Integral Calculator</h2>
                        <p className="text-gray-400 mb-4">
                            Enter your function to find the antiderivative (indefinite integral).
                        </p>
                        <ul className="list-disc pl-5 text-gray-400 space-y-2">
                            <li>Polynomials (e.g., <code className="bg-slate-800 px-1 rounded">x^2 + 3x</code>)</li>
                            <li>Trig functions (e.g., <code className="bg-slate-800 px-1 rounded">sin(x)</code>)</li>
                            <li>Exponentials (e.g., <code className="bg-slate-800 px-1 rounded">e^x</code>)</li>
                        </ul>
                    </div>
                </div>
            </div>
